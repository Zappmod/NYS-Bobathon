...
![Java Modernization workflow card in the Workflows tab](images/snap-04.png)
...
![Analyze Project panel with project path auto-populated](images/snap-05.png)
...
![Select Modernization Type panel with Java Upgrade selected and Git Flow off](images/snap-01.png)
...
![Java Upgrade Configuration panel with Semeru, Java 21, and Jakarta EE 10 selected](images/snap-02.png)
...
![CVE scan subtask prompt asking to fix detected vulnerabilities](images/snap-03.png)
